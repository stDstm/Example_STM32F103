...
//+=============================================================================
//
uint8_t sendPronto (char* s,  uint8_t repeat,  uint8_t fallback)
{
	int       i;
	int       len;
	int       skip;
...
//
uint8_t  validate (char* cp,  int* len)
{
...
//
uint8_t  decode (char* s,  pronto_t* p,  irCode_t* ir)
{
	int    i, len;
	char*  cp;
